...
class DialogSearchSeeAllProduct extends StatefulWidget {
  final String title;
  int groupCategoryID;

  DialogSearchSeeAllProduct({
    super.key,
    required this.title,
  ...
  @override
  State<DialogSearchSeeAllProduct> createState() =>
      _DialogSearchSeeAllProductState();
}

class _DialogSearchSeeAllProductState
    extends State<DialogSearchSeeAllProduct> {
  ...
  void _onSearchChanged(String value) {
    ...
    _debounce = Timer(const Duration(milliseconds: 350), () {
      ...
      vm.seeAllsearchProduct(
        groupCategoryID: widget.groupCategoryID,
        keyword: value,
        offset: 0,
        limit: _pageSize,
