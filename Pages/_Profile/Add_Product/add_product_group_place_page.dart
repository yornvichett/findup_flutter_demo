...
import 'package:findup_mvvm/Pages/_Profile/Add_Product/add_product_page.dart';
import 'package:findup_mvvm/Pages/_Category_Filtter/2_category_show_product_page.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class AddProductGroupPlacePage extends StatefulWidget {
  GroupCategoryModel groupCategoryModel;


  AddProductGroupPlacePage({
    super.key,
  ...
  @override
  State<AddProductGroupPlacePage> createState() =>
      _AddProductGroupPlacePageState();
}

class _AddProductGroupPlacePageState extends State<AddProductGroupPlacePage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          '${Translator.translate('place')} (${Translator.translate(widget.groupCategoryModel.keyTranslate)})',
      ...
      body: groupPlaceViewModel.isLoading
          ? Center(
            ...
            children: [
              Text(
                Translator.translate(
                  groupPlaceModelitem.keyGroupPlaceTranslate,
                ),
