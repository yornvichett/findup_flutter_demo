...
class EditProfileDialogElement extends StatefulWidget {
  final Function(String imagePath) onConfirm;

  const EditProfileDialogElement({
    super.key,
    required this.onConfirm,
  });

  @override
  State<EditProfileDialogElement> createState() =>
      _EditProfileDialogElementState();
}

class _EditProfileDialogElementState
    extends State<EditProfileDialogElement> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      Translator.translate("upload_profile"),
