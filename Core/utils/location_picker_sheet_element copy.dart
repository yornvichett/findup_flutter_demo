...
class LocationPickerSheet extends StatefulWidget {
  final List<SubPlaceModel> locations;
...
class _LocationPickerSheetState extends State<LocationPickerSheet>
  ...
  late List<SubPlaceModel> filtered;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            Translator.translate('select_location'),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: Translator.translate('search_city_or_area'),
                      ...
                      ? Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 10),
                              Text(
                                "${Translator.translate('location_not_found')} ❌",
                                style: GoogleFonts.poppins(
                                  color: Colors.grey,
                                  fontSize: 16,
                                ),
